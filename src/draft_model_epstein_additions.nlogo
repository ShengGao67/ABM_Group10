...
to setup-turtles
  ...
  [
    ...
    set jailed? false
    set active? false
    ifelse random-float 1 <= news-ratio [ set news? true set shape "newsAgent" ] [ set news? false ]
...
Polygon -13840069 true false 225 60 165 30 120 75 180 120 120 195 45 180 45 240 135 255 255 90 225 60
