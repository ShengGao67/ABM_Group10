...
to determine-enforce
  ...
  if chance >= 0.85243 and Defected? [set NotDefected? false
  set Pdef 1]
  if chance < 0.85243 and Defected? [set NotDefected? true
                                  set Defected? true
   set Pdef 0]
...
to-report chance
  ...
  set v random 3.5
  (ifelse
    v = 0 [set percentage 10]
    v = 1 [set percentage 30]
    v = 2 [set percentage 50]
    [set percentage 70])
